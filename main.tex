...
В данном задании нам  нужно отфильтровать исходный звуковой сигнал. Для начала построим его модуль Фурье-образа.
...
После обратного преобразования Фурье к получившемуся образу построим графики звуковых сигналов до и после фильтрации.
